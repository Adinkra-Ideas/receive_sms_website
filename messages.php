...
<head>
    ...
    <title>+1 747 292 0712 SMS Messages - ReceiveTheSMS</title>
    <style>
        /* CSS Styles */
        * {
            margin: 0;
...
<body>
    ...
    <header>
        ...
        <div class="header-content container">
            ...
            <p>Active Temporary Number - Messages Auto-Refresh Every 30 Seconds</p>
        </div>
    </header>
            ...
            <div class="number-header-top">
                ...
                <div>
                    <div class="phone-number-header">
                        <span class="phone-number">+1 747 292 0712</span>
        ...
        <div class="sms-list">
            ...
            <div class="sms-card">
                ...
                <div class="sms-content">
                    [Google] Your verification code is: 583921
                </div>
                <div class="sms-time">
                    <i class="far fa-clock"></i>
                    2023-12-20 14:30:25 UTC
                </div>
            </div>
            ...
            <div class="sms-card">
                ...
                <div class="sms-content">
                    Amazon Alert: Your package has been shipped (TRK: 1Z999AA10123456784). there is still time for you to reconsider.
                </div>
                <div class="sms-time">
                    <i class="far fa-clock"></i>
