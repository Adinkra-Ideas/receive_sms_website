...
<body>
    <header>
        ...
        <div class="header-content container">
            <h1>
                <img src="/images/us.png" alt="USA Flag" class="header-flag">
                United States Phone Numbers
            </h1>
            <p>Free USA Temporary Phone Numbers for Secure SMS Verification</p>
        </div>
    </header>
            ...
            <div class="intro-content">
                ...
                <div class="feature-grid">
                    ...
                    <div class="feature-card">
                        ...
                        <p>Receive SMS from US services anywhere in the world</p>
                    </div>
                ...
                <div class="usage-description">
                    <p class="highlight">
                        Our USA phone numbers are perfect for:
                    </p>
        ...
        <div class="number-grid">
            ...
            <div class="number-card">
                ...
                <div class="number-header">
                    ...
                    <div class="number-info">
                        <a href="#sms-messages" class="sms-link">
                            <h3 class="phone-number-active">+1 415 555 0135</h3>
                        </a>
                    </div>
                </div>
                <div class="copy-section">
                    <div class="action-group">
                        <a href="/messages" class="sms-link">
            ...
            <div class="number-card">
                ...
                <div class="number-header">
                    <img src="/images/us.png" alt="USA Flag" class="country-flag">
                    <div class="number-info">
                        <h3 class="phone-number-expired">+1 347 555 0182</h3>
                    </div>
                </div>
                <div class="copy-section">
                    <div class="action-group">
                        <span class="sms-link"></span>
                        <button class="copy-btn" disabled>
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M20 12l-8 8-4-4M4 6h16M4 12h8M4 18h4"/>
                            </svg>
                            Refresh
                        </button>
                    </div>
                </div>
            </div>            <!-- Expired Number Card -->
            <div class="number-card">
                <span class="status-dot status-expired"></span>
                <div class="number-header">
                    <img src="/images/us.png" alt="USA Flag" class="country-flag">
        ...
        document.querySelectorAll('.copy-btn').forEach(button => {
            if(!button.disabled) {
                button.addEventListener('click', () => {
                    ...
                    document.querySelector('.copy-btn .innerBtnText').innerHTML = 'Copied!';

                    setTimeout(() => {
                        button.classList.remove('copied');
                        document.querySelector('.copy-btn .innerBtnText').innerHTML = 'Copy';
                    }, 2000);
                });
            }
        });
